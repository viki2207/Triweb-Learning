...
var getUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, userId, err, user, error_2;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (req.userId != req.params.userId) {
                    err = new error_1["default"]("You are not Authorized");
                    err.statuscode = 500;
                    err.data = { hi: "Its error " };
                    throw err;
                }
                return [4 /*yield*/, user_1["default"].findById(userId, { name: 1, email: 1 })];
            case 1:
                user = _a.sent();
                if (!user) {
...
var updateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, err, userId, user, err, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                if (req.userId != req.body._id) {
                    ...
                    err = new error_1["default"]("You are not Authorised");
                    err.statuscode = 401;
                    throw err;
                }
                userId = req.body._id;
